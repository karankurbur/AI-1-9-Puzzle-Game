...
public class AStar {
	...
	// Puzzle p = new Puzzle("123456789AB_DEFC");
	...
	public AStar(String puzzle, String h) {
		if (h.equals("h1")) {
			h1 h1 = new h1();
			fringe = new PriorityQueue<TreeNode>(h1);
			visitedSet = new HashSet<String>();
	...
	public static class h1 implements Comparator<TreeNode> {
		public int compare(TreeNode arg0, TreeNode arg1) {
			return (arg0.depth - arg1.depth) + (arg0.data.h1 - arg1.data.h1);
		}
	}

	public static class h2 implements Comparator<TreeNode> {
		public int compare(TreeNode arg0, TreeNode arg1) {
			return (arg0.depth - arg1.depth) + (arg0.data.h2 - arg1.data.h2);
		}
	}
